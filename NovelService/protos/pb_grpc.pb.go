...
func (c *novelClient) Channel1(ctx context.Context, in *CallbackRequest, opts ...grpc.CallOption) (*CallbackReply, error) {
	out := new(CallbackReply)
	err := c.cc.Invoke(ctx, "/manga.Novel/Channel1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNovelServer) Channel1(context.Context, *CallbackRequest) (*CallbackReply, error) {
...
func _Novel_Channel1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CallbackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NovelServer).Channel1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/manga.Novel/Channel1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NovelServer).Channel1(ctx, req.(*CallbackRequest))
	}
...
var Novel_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "manga.Novel",
	HandlerType: (*NovelServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Channel1",
			Handler:    _Novel_Channel1_Handler,
		},
	},
